...
So, Basically all the code behind the scenes has been changed in this update, This means that there might be new silly bugs or things behaving slightly different. If you run into issues, **Please join the [Discord](https://beepsterr.com/discord) for support!**
...
`betterkeepinventory.help` and `betterkeepinventory.info` have been granted to everyone by default.
